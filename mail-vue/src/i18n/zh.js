const zh = {
    ...
    clickToUpload: '点击上传',
    onlyExcelFiles: '只能上传 .xlsx/.xls 文件',
    import: '导入',
    cancel: '取消',
    confirm: '确认',
    warning: '警告',
    confirmClearAll: '确定要清空所有账号吗？',
    emailAlreadyExists: '邮箱已存在',
    addedToList: '已添加到列表',
    pleaseSelectFile: '请选择文件',
    importSuccess: '成功导入 {count} 个账号',
    importFailed: '导入失败',
    noAccountsToSubmit: '没有账号可提交',
    addSuccess: '添加成功',
    addFailed: '添加失败',
    batchSubmitComplete: '批量提交完成：成功 {success} 个，失败 {fail} 个',
    noAccountsToExport: '没有账号可导出',
    exportSuccess: '导出成功',
    autoGenerate: '自动生成',
    enterCount: '请输入生成数量',
    generateAccounts: '生成账号',
    invalidCount: '请输入有效的数量',
    countTooLarge: '生成数量不能超过100个',
    generateSuccess: '成功生成 {count} 个账号',
    generatePartialSuccess: '生成了 {generated} 个账号，请求生成 {requested} 个（可能存在重复）',
    username: '用户名',
}
export default zh
